...
function Projects() {
    ...
    const [readyCarousels, setReadyCarousels] = useState({});

    useEffect(() => {
        let cancelled = false;

        caseStudies.forEach((project) => {
            const preloadImages = project.images.map(({ src }) =>
                new Promise((resolve) => {
            ...
            Promise.all(preloadImages).then(() => {
                if (!cancelled) {
                    setReadyCarousels((current) => ({ ...current, [project.id]: true }));
                }
            });
        });
                                ...
                                <div className="case-study-visual">
                                    ...
                                    <div className="carousel-bar">
                                        <button
                                            ...
                                            disabled={!readyCarousels[project.id]}
